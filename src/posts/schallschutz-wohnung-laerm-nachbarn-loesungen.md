...
excerpt: Schallschutz in Altbauwohnungen und Plattenbauten in Sofia und Bulgarien – Trittschall von oben, Stimmen durch die Wand, Straßenlärm. Was die Ursachen sind und was wirklich hilft.
...
## Schallschutz in der Praxis: Welche Maßnahme gegen welchen Lärm?

Die entscheidende Frage ist nicht, was eine Maßnahme kostet — sondern ob sie gegen **Ihren** Lärm überhaupt wirkt:

| Maßnahme | Wirkt gegen | Bezugsgröße |
|---|---|---|
| Trittschalldämmung (schwimmender Estrich) | Schritte, Möbelrücken von oben | Bodenfläche des Raums |
| Vorsatzschale | Luftschall durch die Wand (Stimmen, TV) | Wandfläche |
| Schallschutzfenster | Straßen- und Außenlärm | Anzahl und Größe der Fenster |
| Balkonverglasung Schallschutz | Außenlärm, wenn der Balkon die Schwachstelle ist | Verglaste Fläche |
| Gesamtsanierung | Mehrere Schallwege gleichzeitig | Wohnungsgröße |

**Warum hier keine Preise stehen:** Weil die Zahl ohne die Diagnose wertlos ist — und mit der Diagnose brauchen Sie keine Spanne mehr, sondern einen verbindlichen Festpreis. Den bekommen Sie nach einer **kostenlosen Videoanalyse**.
...
**Schritt 1: Videoanalyse (30 Minuten)**
Sie zeigen uns die betroffenen Bereiche, schildern wann und wie der Lärm auftritt. Wir stellen gezielte Fragen (Wann ist es am schlimmsten? Aus welcher Richtung? Veränderungen je nach Jahreszeit?) und machen eine erste Einschätzung der Lärmquelle.

**Schritt 2: Vor-Ort-Inspektion**
Bei komplexeren Situationen oder wenn eine genaue Messung erforderlich ist, kommen wir vor Ort. Wir messen Schallpegel, identifizieren Schallbrücken und erstellen ein vollständiges Analyseprofil.

**Schritt 3: Maßnahmenplan und Angebot**
Sie erhalten einen konkreten Maßnahmenplan – priorisiert nach Wirkung und Kosten. Kein Einheitspaket, sondern eine Lösung die zu Ihrer Wohnung und Ihrem Budget passt.

**Schritt 4: Umsetzung mit Garantie**
Wir führen die Arbeiten durch oder koordinieren lokale Handwerksbetriebe – mit Qualitätskontrolle und Garantie.

## Haben Sie ein Schallschutz- oder Lärmschutzproblem in Ihrer Wohnung?

Fünf Fragen zur Selbsteinschätzung:

1. Hören Sie den Nachbarn über Ihnen beim Gehen, Kochen oder Möbelrücken?
2. Verstehen Sie Gespräche aus der Nachbarwohnung?
3. Schläft jemand in Ihrem Haushalt schlecht wegen Lärm?
4. Haben Sie einen verglasten Balkon, der wenig gegen Außenlärm schützt?
5. Hat sich das Problem seit dem Einzug verschlechtert?

Wenn Sie zwei oder mehr Fragen mit Ja beantwortet haben: Es gibt eine Lösung – die richtige Analyse ist der erste Schritt.

**Buchen Sie jetzt eine kostenlose 30-minütige Videoanalyse.** Wir schauen uns Ihre Situation an, nennen Ihnen die wahrscheinliche Ursache und was dagegen zu tun ist.

**peak-care.com** | peakcare@peak-care.com | +359 89 843 6561

25 Jahre Erfahrung. 500+ sanierte Objekte. Schallschutz ist lösbar.
